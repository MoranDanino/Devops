...
resource "aws_route_table_association" "routetable_ass_publicsubnet1" {
...
resource "aws_route_table_association" "routetable_ass_publicsubnet2" {
    route_table_id = aws_route_table.route_table_public.id
